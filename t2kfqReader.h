#ifndef t2kfqReader_h
#define t2kfqReader_h
...
#ifdef t2kfqReader_cxx
t2kfqReader::t2kfqReader(TChain *tree)
{
...
t2kfqReader::~t2kfqReader()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t t2kfqReader::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t t2kfqReader::LoadTree(Long64_t entry)
{
...
void t2kfqReader::Init(TChain *tree)
{
...
void t2kfqReader::Show(Long64_t entry)
{
...
Int_t t2kfqReader::Cut(Long64_t entry)
{
