...
// Wed Aug 26 15:30:41 2015 by ROOT version 5.28/00c
// from TTree h1/DST
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("stopmu_mc_1390_for_atmnu_test_064994.001_stmusel_009_141224_fQ.root");
      if (!f) {
         f = new TFile("stopmu_mc_1390_for_atmnu_test_064994.001_stmusel_009_141224_fQ.root");
      }
