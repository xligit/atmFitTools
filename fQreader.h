...
// Mon Aug 31 14:51:08 2015 by ROOT version 5.28/00c
// from TTree h1/DST
// found on file: cosmicdata.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("cosmicdata.root");
      if (!f) {
         f = new TFile("cosmicdata.root");
      }
